# app_relatorio.py (VERSÃO FINAL, COMPLETA E CORRIGIDA)
...
if df_final.empty:
    ...
    with st.spinner("Gerando todas as análises..."):
        ...
        with st.expander("Análise de Similaridade (Diversidade Beta)", expanded=False):
            ...
            matriz_sim = df_final.pivot_table(index='ponto_amostral', columns='especie', values='densidade', aggfunc='sum', fill_value=0); matriz_sim = matriz_sim.loc[matriz_sim.sum(axis=1) > 0]
